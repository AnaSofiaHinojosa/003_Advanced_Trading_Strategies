# Entrypoint for training and logging models with MLflow
...
def trainlog() -> None:
    ...
    train_and_log_mlp(x_train_norm, y_train_norm, x_test_norm, y_test_norm,
                      x_val_norm, y_val_norm, params_space_mlp, epochs=100, batch_size=32)

    mlflow.set_experiment("CNN Tuning")
    train_and_log_cnn(x_train_norm, y_train_norm, x_test_norm, y_test_norm,
                      x_val_norm, y_val_norm, params_space_cnn, epochs=100, batch_size=32)
